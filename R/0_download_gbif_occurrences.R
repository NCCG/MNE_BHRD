...
###                     USING A LIST OF NAMES OF SPECIES                     ###
...
gbif_taxon_keys <-
  read.csv("./data/registros/list_56spp.csv", sep = ';') %>% #For an file with a list of spp names
  pull(names_wo_author) %>% #Specify the column from the list
